...
from app.routes import analytics_balcao, analytics_caracteristicas, analytics_evolucao, coleta_balcao, coleta_caracteristicas, debentures
...
def create_app(env: str = "dev") -> FastAPI:
    ...
    app.include_router(analytics_balcao, prefix="/api/analytics/balcao", tags=["Analytics"])
